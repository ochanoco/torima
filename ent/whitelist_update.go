...
func (wlu *WhiteListUpdate) SetURL(s string) *WhiteListUpdate {
	wlu.mutation.SetURL(s)
	return wlu
}
...
func (wlu *WhiteListUpdate) SetOwner(p *Project) *WhiteListUpdate {
	return wlu.SetOwnerID(p.ID)
}
...
func (wlu *WhiteListUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := wlu.mutation.URL(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: whitelist.FieldURL,
		})
	}
...
// SetURL sets the "url" field.
func (wluo *WhiteListUpdateOne) SetURL(s string) *WhiteListUpdateOne {
	wluo.mutation.SetURL(s)
	return wluo
}
...
// SetOwner sets the "owner" edge to the Project entity.
func (wluo *WhiteListUpdateOne) SetOwner(p *Project) *WhiteListUpdateOne {
	return wluo.SetOwnerID(p.ID)
}
...
func (wluo *WhiteListUpdateOne) sqlSave(ctx context.Context) (_node *WhiteList, err error) {
	...
	if value, ok := wluo.mutation.URL(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: whitelist.FieldURL,

...
func (spq *ServiceProviderQuery) loadWhitelists(ctx context.Context, query *WhiteListQuery, nodes []*ServiceProvider, init func(*ServiceProvider), assign func(*ServiceProvider, *WhiteList)) error {
	...
	for _, n := range neighbors {
		...
		if fk == nil {
			return fmt.Errorf(`foreign-key "service_provider_whitelists" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
